...
> 编号与模板一一对应：1.1 功能清单 / 1.2 需求质量核对（/req-gate） / 1.3 澄清 / 2.1 项目约束 / 3.x 技术方案 / 4.1 任务拆解、4.2 契约测试 / 5.1 编码、5.2 规范核对（强制独立节点，产物 5.2 规范核对报告）、5.3 验收。产物落盘见下方「落盘规则」。
...
| 1.1 | 生成功能清单总览（需求准入：分档 A/B/C + 验收基线；表格；先过滤非 Java 服务端需求） | `templates/1.1-功能清单.md` |
